...
@section('body')
	...
	<div class="rodapeStatus rodape">
		<div class="status-saida" id="status-saida">
	        ...
	        <span><strong>Peso liq.: </strong>{{ isset($totalItens->t_liq) ? formataNumero($totalItens->t_liq) : 0 }}</span>
	        <span><strong>Peso Bru. Apro.: </strong>{{ isset($totalItens->t_liq) ? formataNumero($totalItens->t_liq + ($totalItens->qtd_pallets*100) : 0) }}</span>
		</div>
